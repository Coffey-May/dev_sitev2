...
const Weather = props => (
    <div style={{ display: "flex", FlexDirection: 'row', flexWrap: 'wrap', overflow: '  scroll' }} className="weather__info">
        <div style={{ margin: '2em' }}>
            ...
            <hr />
            {
                props.city && props.country && <h2 style={{ margin: '0 auto' }} className="weather__key"> Location:
        ...
        <div>
            {
                <div className="sun-2-container">
                    <img className="weather-pic" style={{ padding: '2em', margin: '.5em', width: '40vw' }} src={Pic} alt="" />
