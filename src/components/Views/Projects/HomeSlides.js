...
const imgStyle = { border: '13px solid #f5fff8', height: '15em', width: '23em', margin: '1rem', boxShadow: ' 5px 10px 18px #0b0e29' }
let link1 = '/weather'
let link2 = '/todo'
...
export default function HomeSlides() {
    return (
        ...
        <div id="colorBG" style={{ webkitOverflowScrolling: 'touch', height: '80vh', width: '100vw', margin: '0 auto' }}>
            <Slider speed={1500}>
                {slides.map((slide, index) => <div style={{ overflow: 'visible', height: '80vh', color: 'white', padding: '2em' }} key={index}>
