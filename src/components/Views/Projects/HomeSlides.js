...
const imgStyle = { backgroundImage: 'cover', border: '5px solid #f5fff8', height: '19vh', width: '24vw', margin: '1rem', boxShadow: ' 5px 10px 18px #0b0e29' }
let link1 = '/weather'
let link2 = '/todo'
            ...
            <Slider speed={1500}>
                {slides.map((slide, index) => <div style={{ overflow: 'scroll', height: '80vh', color: 'white', padding: '2em' }} key={index}>
                    ...
                    <div style={{ width: '65vw', margin: '0 auto' }}>
                        <h3 style={{ fontSize: '2em' }}>{slide.description}</h3>
                    </div>
