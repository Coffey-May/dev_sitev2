...
const slides = [
    ...
    { title: 'What Should I Eat?', image: `${pic7}`, image2: `${pic8}`, image3: `${pic9}`, description: 'This project allows a user to consume a REST api containing recipe data, and the ability to search for recipes by keyword.', link: `${link3}` }
];
