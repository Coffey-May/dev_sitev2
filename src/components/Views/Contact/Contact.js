        ...
        <>
            <div className="Contact">
                <div>
                    ...
                    <div style={{ height: '80vh', color: `#fff`, margin: '0', backgroundColor: 'black', opacity: '0.7', justifyContent: 'center' }}>
                        <h1 style={{ fontFamily: 'Poiret One, cursive', color: 'white', margin: '0 auto', paddingTop: '2vh', fontSize: '4em' }}>Contact</h1>
                        <hr />
